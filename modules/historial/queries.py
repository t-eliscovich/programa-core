...
TIPOS_LABEL = {
    ...
    "posdat_restaurada":        "Deuda restaurada (se había borrado sin pagarse)",
...
#: ⭐ Tamara 05/09/2026, viendo "CJ → CP", "CJ VI → DV", "CJ entra" en la
#: traza: la CAJA va en palabras ("Caja VI → retiro", "entró a caja", "Caja →
#: compra"). Es la única que se lee como clave: el resto de los códigos (CH,
#: FA, BC, AN) los definió ella y se quedan.
TIPOS_CORTO = {
    ...
    "caja_e_simple": ("entró a caja", ""),
    "caja_s_simple": ("salió de caja", ""),
    "caja_cb_simple": ("Caja", "contra banco"),
    "caja_e_directo": ("entró a caja", ""),
    "caja_s_directo": ("salió de caja", ""),
    "caja_cb_directo": ("Caja", "contra banco"),
    "caja_s_to_transfer_banco": ("Caja", "→ banco"),
    "caja_e_to_transfer_banco": ("Caja", "← banco"),
    "caja_s_to_retiro_socio": ("Caja", "→ retiro"),
    "caja_s_to_dolares": ("Caja", "→ anticipo"),
    "caja_e_to_dolares": ("Caja", "← anticipo"),
    "caja_s_to_compra_proveedor": ("Caja", "→ compra"),
    "caja_s_to_xgast": ("Caja", "→ gasto"),
