...
### [S] Fase 6: leer `C:\metabase\gc.log` (desde el 06/09) y decidir el heap de Metabase — el heap NO fue el problema del 05/09 (fue el metaspace); no bajar sin el dato
