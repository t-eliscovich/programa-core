...
ROLES: list[tuple[str, list[str]]] = [
    ...
    ("Administrador", [
        "informes.ver", "flujo.ver",
        "bitacora.ver", "usuarios.admin",
        "periodo.cerrar",
        "roles.ver", "roles.editar",
        "clientes.ver", "proveedores.ver",
        "facturas.ver", "cheques.ver", "compras.ver", "bancos.ver",
        "cartera.ver", "deudas.ver",
        "retenciones.ver", "activos.ver", "activos.crear", "activos.amortizar",
        "iniciales.editar",
        "caja.ver", "provisiones.ver", "proformas.ver",
        "ventas.ver", "gastos.ver", "retiros.ver",
        "historia.ver", "iniciales.ver",
        "capital.ver", "posdat.ver",
        "sri.ver",
    ]),
    ("Gerente", [
        "informes.ver", "flujo.ver",
    ...
    ("Contabilidad", [
        ...
        "cheques.ver", "cheques.crear", "cheques.editar", "cheques.transicionar",
        "cheques.aplicar", "cheques.anular",
        "compras.ver", "compras.editar",
        "bancos.ver", "bancos.conciliar",
        "retenciones.ver", "retenciones.emitir", "retenciones.anular",
        "caja.ver", "caja.crear",
        "capital.ver", "capital.crear",
        "provisiones.ver",
        "posdat.ver",
        "activos.ver", "activos.crear", "activos.amortizar",
        "ventas.ver", "gastos.ver", "gastos.crear", "retiros.ver",
        "historia.ver", "iniciales.ver",
        "cartera.ver", "deudas.ver",
        "flujo.ver",
        "sri.ver", "sri.emitir",
    ...
    ("Compras", [
        ...
        "provisiones.ver", "provisiones.crear", "provisiones.editar",
        "posdat.ver", "posdat.crear", "posdat.editar", "posdat.anular",
        "deudas.ver",
        "bancos.ver",
    ]),
    ("Cobranzas", [
        "clientes.ver", "clientes.editar",
        "cupos.editar", "stop_cliente.editar",
        "facturas.ver",
        "cheques.ver", "cheques.crear", "cheques.aplicar", "cheques.anular",
        "retenciones.ver", "retenciones.emitir",
    ...
    ("Ventas", [
        ...
        "facturas.ver",
        "cheques.ver",
        "proformas.ver", "proformas.crear",
    ]),
    ("Bodega", [
        "productos.ver",
        "stock.ver", "stock.mover",
        "compras.ver",
    ]),
    ("QC", [
        "tintura.ver", "tintura.registrar",
        "costos.ver", "precios.ver", "productos.ver",
        "formulas.ver",
    ]),
    ("Lectura", [
        "informes.ver",
        "clientes.ver", "proveedores.ver",
        "facturas.ver", "cheques.ver", "compras.ver", "bancos.ver",
        "cartera.ver", "deudas.ver", "ventas.ver",
        "historia.ver", "iniciales.ver",
        "activos.ver", "caja.ver", "provisiones.ver", "proformas.ver",
        "capital.ver", "posdat.ver",
        "sri.ver",
    ]),
]
