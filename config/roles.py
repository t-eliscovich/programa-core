...
ROLES: list[tuple[str, list[str]]] = [
    ...
    (
        "Administrador",
        [
            # TMT 2026-05-26 dueña: "Andres debería ver todo". Antes el rol
            # Administrador tenía solo perms de ver — sin bancos.conciliar,
            # cheques.crear, caja.crear, etc. Le damos wildcard `*` (igual
            # que Accionista a nivel funcional; conceptualmente sigue
            # siendo otro rol — Administrador no es dueño legal).
            "*",
        ],
    ),
    (
