...
# scintela.precios en producción, 03/09/2026 (NETO, 4 decimales; LYCRA = Fleece Lycra).
_MATRIZ_PROD = [dict(zip(_COLS, r, strict=True)) for r in [
    [1, "BLANCO", 7.9391, 8.53, 8.03, 10.81, 8.0609, 8.21, 10.4, 7.26, 7.5217, 10.4522, 7.72, 7.72],
    [2, "BAJOS", 8.5739, 9.17, 8.64, 11.45, 8.17, 8.31, 11.0696, 7.26, 7.5217, 10.4522, 7.72, 7.72],
    [3, "MEDIOS", 9.2, 9.84, 9.287, 12.08, 8.53, 8.6783, 11.0696, 7.26, 7.5217, 10.4522, 7.72, 7.72],
    [4, "JASPEADOS", 9.2783, 9.57, 9.3739, 11.85, 8.27, 9.05, 11.0696, 7.26, 7.5217, 10.4522, 7.72, 7.72],
    [5, "FUERTES", 9.82, 10.51, 9.913, 12.7043, 9.11, 9.25, 11.4261, 7.26, 7.5217, 10.4522, 7.72, 7.72],
]]
_PLANOS_PROD = [
